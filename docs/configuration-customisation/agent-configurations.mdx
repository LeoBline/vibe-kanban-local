...
description: "Configure and customise Claude Code variants with different settings for planning, models, and sandbox permissions"
---

Agent profiles let you define multiple named variants for Claude Code. Variants capture configuration differences like planning mode, model choice, and sandbox permissions that you can quickly select when creating attempts.
...
<Accordion title="Structure Rules">
  ...
  - **Custom variants**: Add new variants like `PLAN` as needed
